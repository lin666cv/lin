...
<div class="articleDetail-container">
  <div class="header-section">
    <div class="header-content">
      <el-image :src="imageUrl" alt="文章详情" style="width: 60px; height: 60px;" />
      <h1>文章详情</h1>
    </div>
  </div>
  <div class="content">
    <div class="diary-card">
      ...
      <div class="sub-title">
        <el-tag type="primary" Plain size="large" class="category-tag">{{ articleDetail.categoryName }}</el-tag>
        <div class="flex-box">
      ...
      <div class="flex-box item">
        ...
        <span>观看人数 {{articleDetail.readCount}}次阅读</span>
      </div>
      </div>
    </div>
    <div class="diary-card">
       ...
       <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
              <div class="tags-list">
                  <el-tag v-for="tag in articleDetail.tagArray" :key="tag" type="info" effect="light">
                    {{ tag }}
                </el-tag>
              </div>
       </div>
