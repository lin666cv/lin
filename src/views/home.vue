      ...
      <div class="text">
       ...
       <span class="highlight-text">化孤独为慰藉</span>
        ...
        <div class="hero-actions">
          <el-button  size="large" type="primary" @click="goConsultationPage">开始倾诉</el-button>
          <el-button  size="large" style="border-color: #fff;" color="transparent" @click="goEmotionDiaryPage">记录心情</el-button>
        </div>
      </div>
      <div class="robot">
        <el-image :src="iconUrl" style="width: 150px; height: 150px;" class="robot-image" />
      </div>
    </div>
  </div>
</template>
